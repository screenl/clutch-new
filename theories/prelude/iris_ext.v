...
Global Instance iPropI_Sbi {Σ} : Sbi (iPropI Σ). by apply uPred_sbi. Qed.
...
Section fupd_plainly_derived.
  Context {PROP : bi}.
  Context `{!BiFUpd PROP, !Sbi PROP, !BiFUpdSbi PROP, !BiAffine PROP}.
...
Section class_instance_updates.
  ...
  Global Instance from_forall_step_fupdN
    `{!BiFUpd PROP, !Sbi PROP, !BiFUpdSbi PROP, !BiAffine PROP} E {A} P (Φ : A → PROP) name n :
