...
(* Locate discprob.basic.classic_proof_irrel.PIT.subsetT_eq_compat.
...
Ltac simplify_eq_d :=
  simplify_eq;
  repeat match goal with
  | H : @existT ?A ?P ?p ?x = @existT ?A ?P ?p ?y |- _ =>
    apply classic_proof_irrel.PIT.EqdepTheory.inj_pair2 in H
  end;
  simplify_eq.
